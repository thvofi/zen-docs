...
`insert screenshot of split view here`
...
```
insert video of these sequences:
...
`insert gif/video of dragging splitted tab and then pressing ‒ button to unsplit it`
...
`insert gif/video of horizontal, vertical, and grid toggling split view here` 
